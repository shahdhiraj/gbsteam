  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-5 sm:px-8 bg-white dark:bg-transparent text-[#161616] dark:text-white">
      <div className="mx-auto max-w-5xl">
        <Link
          to="/#projects"
          className="inline-flex items-center gap-2 text-sm font-bold text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 mb-8 transition-colors"
        >
          <ArrowLeft size={16} />
          Back to Projects
        </Link>
