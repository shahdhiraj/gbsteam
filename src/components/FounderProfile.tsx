...
export function FounderProfile() {
  ...
  return (
    <section
      id="founder"
      className="relative px-5 py-12 sm:px-8 lg:px-12 bg-white dark:bg-transparent"
    >
            ...
            >
              ...
              <div className="flex flex-col justify-center">
                ...
                <blockquote className="text-sm sm:text-base italic text-slate-600 dark:text-slate-300 leading-relaxed border-l-4 border-brand-500 pl-4 py-1 bg-brand-50 dark:bg-transparent rounded-r-lg">
                  "My dream is to make Nepal self-sufficient in robotics
                  technology and contribute to national prosperity through
                  innovation, defense technology, and industrial automation."
                </blockquote>
                <a
                  href="#"
                  className="mt-6 self-start inline-flex rounded-lg bg-[#086638] px-5 py-2.5 text-xs font-bold text-white transition hover:bg-[#0a7d45] shadow-sm"
                >
                  Read Full Profile
                </a>
              </div>
            ...
            >
              ...
              <ul className="flex flex-col gap-5">
                {achievements.map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-4 text-[15px] font-semibold text-[#ffffff]"
                  >
                    <CheckIcon
                      size={20}
