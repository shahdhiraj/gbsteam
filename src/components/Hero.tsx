      ...
      <div className="mx-auto grid max-w-[1440px] items-center gap-14 lg:grid-cols-[1.05fr_.95fr] lg:gap-8">
        ...
        >
          ...
          <p className="mt-7 max-w-xl text-base leading-7 text-slate-300 sm:text-lg">
            GBS Team is Nepal&apos;s leading Robotics Research &amp; Development
            organization founded by Er. Ganesh Bikram Singh Ale and Er. Yagya
            Prasad Devkota. We specialize in Robotics (UGV, UAV, ROV &amp;
            Military Technologies), AI, Automation, and STEM Education while
