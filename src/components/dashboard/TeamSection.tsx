...
export function TeamSection({
  ...
  const filteredTeam = localTeamMembers.filter((m) =>
  ...
  const handleAddMember = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newMember: TeamMember = {
      ...
      image:
        ...
        `https://i.pravatar.cc/150?u=new-member-${Date.now()}`,
    };
      ...
      >
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {filteredTeam.map((member) => (
            <div
              key={member.id}
              className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xl backdrop-blur-sm flex flex-col gap-4 transition-transform hover:-translate-y-1 hover:border-white/[0.2]"
            >
              <div className="flex items-center gap-4">
                <img
                  src={member.image}
                  alt={member.name}
                  className="h-16 w-16 rounded-full object-cover border-2 border-brand-400/50"
                />
                <div className="overflow-hidden">
                  ...
                  <p className="text-xs font-medium text-brand-300 truncate mb-1">
                    {member.role}
                  </p>
            ...
            >
              ...
              <div className="flex flex-col items-center mb-6 text-center">
                <img
                  ...
                  className="h-24 w-24 rounded-full object-cover border-4 border-brand-400/20 mb-4"
                />
              ...
              {viewingMember.linkedin && (
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-5">
                  ...
                  <a
                    ...
                    className="text-sm font-medium text-brand-500 hover:underline break-all"
                  >
                    {viewingMember.linkedin}
                  </a>
                </div>
