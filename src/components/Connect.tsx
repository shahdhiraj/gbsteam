...
export function Connect() {
  ...
  return (
    <section
      id="connect"
      className="relative bg-white dark:bg-[#161616] px-5 py-24 sm:px-8 lg:px-12 border-t border-black/5 dark:border-white/5"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-[#161616] dark:text-white leading-tight">
              Let's Build the{' '}
              <span className="text-brand-600 dark:text-brand-400">Future</span>{' '}
              Together.
            </h2>
            <p className="mt-6 text-lg text-slate-600 dark:text-slate-300 leading-relaxed max-w-xl">
              Whether you're interested in partnering on a robotics project,
              setting up a STEM lab, or joining our research initiatives, we'd
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
              <div className="flex items-start gap-4 group cursor-pointer">
                ...
                <div className="flex flex-col justify-center min-h-[3rem]">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-[#161616] dark:text-white">
                    Location
                  </h3>
                  <p className="mt-1 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                    Balkumari, Lalitpur (Near KUSOM College), Kathmandu, Nepal
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group cursor-pointer">
                ...
                <div className="flex flex-col justify-center min-h-[3rem]">
                  ...
                  <a
                    href="https://www.youtube.com/c/GANESHBIKRAMSINGHALEMAGAR"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-1 text-sm text-brand-600 dark:text-brand-400 hover:underline"
                  >
                    GANESHBIKRAMSINGHALEMAGAR
                  </a>
                </div>
              </div>
            </div>
