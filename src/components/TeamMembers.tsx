...
export function TeamMembers({ preview = false }: { preview?: boolean }) {
  ...
  return (
    <section
      id="team-member"
      className="relative px-5 py-16 sm:px-8 lg:px-12 bg-slate-50 dark:bg-[#0b1728]"
    >
      <div className="mx-auto max-w-[1440px]">
        <div className="mb-12 text-center md:text-left">
          ...
          <p className="mt-4 max-w-2xl text-base text-slate-600 dark:text-slate-400 md:text-lg">
            A dedicated group of over 20+ engineers, researchers, and
            specialists working together to drive robotics innovation in Nepal.
          </p>
        </div>
